 ...
 */
package me.albusthepenguin.api.events;
...
@Getter
public class SkylineSendPlayerEvent extends Event implements Cancellable {
    ...
    /**
     * Is 'true' if the event is canceled.
     */
    private boolean cancelled;

    public SkylineSendPlayerEvent(Player player) {
        this.player = player;
    }
